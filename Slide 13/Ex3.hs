...
avaliaCmd mem (Seq [])= escreve mem "" 0
avaliaCmd mem (Seq (a:l)) = avaliaCmd mem' a where
                              mem'= avaliaCmd mem (Seq l)
--c2= Seq (Atr "x" (Num 1)) (Seq (Atr "y" (Num 2)) (Atr "z" ( Add (Var "x") (Var "y"))))
c3= Atr "x" (Add (Var "x") (Num 20))
c4= Seq [Atr "y" (Num 10),Atr "x" (Num 11)]
--c5 = Atr "x" (Var "x")
main = print (avaliaCmd memory c4)
