...
data Cmd = Atr String Exp
        ...
        deriving Show
{-
Crie uma função avaliaProg :: Cmd -> Int, que recebe um comando e retorna o valor final da variável "ret".

Assuma um ambiente inicial onde variáveis não atribuídas tenham o valor 0 por padrão.
-}
...
c0= Seq (Atr "ret" (Var "x"))(Atr "x" (Add (Num 1)(Num 2)))
