...
print(duplica(10))
-}
a2 =  Seq (Fun "duplica" (Atr "ret" (Add (Var "arg") (Var "arg")))) (Prt (App "duplica" (Num 10)))
{- 3.
def soma (v):
    if v != 0:
        return v + soma(v-1)
...
a3 = Fun "soma" (Cnd (Var "arg") (Atr "ret" (Add (Var "arg") (App "soma" (Sub (Var "arg")(Num 1)))))( Atr "ret" (Num 0)))
