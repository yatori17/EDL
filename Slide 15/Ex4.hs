...
avaliaExp (mem,cod) (App2 id (e1,e2))  = ret where
                                    ret = consulta mem'' "ret"
                                    (mem'',_) = avaliaCmd (mem',cod) fun2
                                    mem' = escreve mem1 "arg2" arg2
                                    mem1 = escreve mem "arg" arg
...
avaliaCmd (mem,cod) (Fun2 id arg arg2 c)    = (mem, escreve cod id cmd') where
                                        cmd'= Seq (Atr arg (Var "arg")) (Seq (Atr arg2 (Var "arg2")) (c))
...
{-a4= Seq (Atr "y" (Num 10)) (Seq (Fun "f" "x" (Seq (Atr "y" (Var "x")) 
    (Seq (Prt (Var "y")) (Atr "ret" (Var "y") )) ))
    (Seq (Prt (App "f" (Num 20))) (Prt (Var "y"))))
    -}

a5= Seq (Fun2 "soma2" "x" "y"(Atr "ret" (Add (Var "arg") (Var "arg2")))) (Prt (App2 "soma2" ((Num 10),(Num 5))))
main = print (avaliaCmd e a5)
